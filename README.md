...
**Note:** The frequency image dataset is too large to upload to this repository. However, it can be generated by running the provided code.<Electrical parameter plots Continuous Wavelet Transform (CWT) spectrograms.ipynb>
